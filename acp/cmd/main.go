...
import (
	...
	"github.com/humanlayer/agentcontrolplane/acp/internal/controller/contactchannel"
	...
	acpotel "github.com/humanlayer/agentcontrolplane/acp/internal/otel"
...
func init() {
	...
	utilruntime.Must(acp.AddToScheme(scheme))
...
func main() {
	...
	tracerProvider, err := acpotel.InitTracer(ctx)
	if err != nil {
