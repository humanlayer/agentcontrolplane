...
func (r *LLMReconciler) validateProviderConfig(ctx context.Context, llm *acp.LLM, apiKey string) error { //nolint:gocyclo
	var err error
	...
	case "mistral":
		...
		// https://github.com/humanlayer/agentcontrolplane/pull/35#discussion_r2013064446
...
func (r *LLMReconciler) validateSecret(ctx context.Context, llm *acp.LLM) (string, error) {
