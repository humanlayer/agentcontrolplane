...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FreestyleConfig) DeepCopyInto(out *FreestyleConfig) {
	*out = *in
	out.APIKeyFrom = in.APIKeyFrom
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FreestyleConfig.
func (in *FreestyleConfig) DeepCopy() *FreestyleConfig {
	if in == nil {
		return nil
	}
	out := new(FreestyleConfig)
